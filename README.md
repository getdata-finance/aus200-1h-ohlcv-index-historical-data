...
**AUS200 1h OHLCV index historical data** — ultra high-quality 1h OHLCV for **S&P/ASX 200**. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
> **Sample on GitHub** · `AUS200_1h.csv` (972 rows, `2026-07-01` -> `2026-09-02`, 65.85 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/aus200)** — **98,924** `1h` rows (full `1m`: 5,275,014), **11 timeframes**, `2008-09-10` -> `2026-09-02`.
...
| 1h rows | 972 | **98,924** |
| Size | 65.85 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/aus200) |
